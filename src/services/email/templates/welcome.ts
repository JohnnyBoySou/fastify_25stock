...
<html lang="pt-BR">
    <head>
      ...
      <style>
        ...
        .button { display: flex; justify-content: center; align-items: center; background: #043721; color: white; padding: 12px 30px; text-decoration: none; border-radius: 8px; margin: 20px 0; }
    ...
    <body>
       ...
       <div class="container">
         <div class="content">
          ...
          <ul>
            <li>Gerenciar produtos, categorias e fornecedores</li>
            <li>Controlar movimentações de estoque</li>
            <li>Gerar relatórios detalhados</li>
            <li>Controlar agendamentos, espaços, funcionários e escalas</li>
            <li>E muito mais!</li>
          </ul>
