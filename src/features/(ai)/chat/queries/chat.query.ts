import { CategoryQueries } from '@/features/(erp)/category/queries/category.queries'
import { MovementQueries } from '@/features/(erp)/movement/queries/movement.queries'
import { ProductQueries } from '@/features/(erp)/product/queries/product.queries'
import { SupplierQueries } from '@/features/(erp)/supplier/queries/supplier.queries'
